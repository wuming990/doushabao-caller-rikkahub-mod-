...
class NotificationConfig {
    ...
    var smallIcon: Int = R.drawable.ic_stat_v261
...
object NotificationUtil {
    ...
    fun buildNotification(
        ...
        return NotificationCompat.Builder(context, channelId).apply {
            ...
            // v261：通知左侧大图必须显式指定新资源名，否则系统会拿缓存里的旧应用图标。
            BitmapFactory.decodeResource(context.resources, R.mipmap.ic_launcher_v261)?.let { setLargeIcon(it) }
