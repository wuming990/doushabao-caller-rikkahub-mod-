...
import me.rerere.rikkahub.di.agentModule
...
import me.rerere.rikkahub.service.WorkspaceBoostManager
...
const val CHAT_COMPLETED_NOTIFICATION_CHANNEL_ID = "chat_completed_v261"
const val CHAT_LIVE_UPDATE_NOTIFICATION_CHANNEL_ID = "chat_live_update_v261"
const val WEB_SERVER_NOTIFICATION_CHANNEL_ID = "web_server_v261"
const val OFFICIAL_TRANSFER_NOTIFICATION_CHANNEL_ID = "official_transfer"
...
class RikkaHubApp : Application() {
    override fun onCreate() {
        ...
        startKoin {
            ...
            workManagerFactory()
            modules(appModule, viewModelModule, dataSourceModule, repositoryModule, agentModule)
        }
        ...
        // workspace boost mode: keep long shell/build tasks at a higher scheduling priority
        WorkspaceBoostManager.init(this, get<AppEventBus>(), get<AppScope>())
    ...
    private fun createNotificationChannel() {
        ...
        val officialTransferChannel = NotificationChannelCompat
            .Builder(OFFICIAL_TRANSFER_NOTIFICATION_CHANNEL_ID, NotificationManagerCompat.IMPORTANCE_LOW)
            .setName(getString(R.string.notification_channel_official_transfer))
            .setVibrationEnabled(false)
            .setShowBadge(false)
            .build()
        notificationManager.createNotificationChannel(officialTransferChannel)
        // v207: 工作区加速已去掉前台服务与通知, 不再创建 workspace_boost 渠道;
        // 从旧版本升级上来的残留渠道由 WorkspaceBoostManager.init 删除。
    }
